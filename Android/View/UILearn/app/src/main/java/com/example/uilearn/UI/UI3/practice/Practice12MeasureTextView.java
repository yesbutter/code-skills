package com.example.uilearn.UI.UI3.practice;
...
public class Practice12MeasureTextView extends View {
    ...
    String text2 = "4.5";
    String text3 = "公斤";
    float text1Position,text2Position;
...

    {
        ...
        text1Position = paint1.measureText(text1);
        text2Position = paint2.measureText(text2);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(text2, 50 + text1Position, 200, paint2);
        canvas.drawText(text3, 50 + text1Position + text2Position, 200, paint1);
    }
}
